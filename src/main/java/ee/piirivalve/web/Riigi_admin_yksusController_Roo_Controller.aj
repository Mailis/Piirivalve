...
privileged aspect Riigi_admin_yksusController_Roo_Controller {
    ...
    public Collection<Admin_alluvus> Riigi_admin_yksusController.populateAdmin_alluvuses() {
    ...
    public Collection<Ruumiyksus> Riigi_admin_yksusController.populateRuumiyksuses() {
